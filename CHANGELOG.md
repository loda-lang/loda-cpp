...
* Fix PARI stack overflow in `test-pari` for sequences with self-referential power operations (A132076) by auto-detecting and switching to vector mode when needed
