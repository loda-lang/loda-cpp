# BEGIN PLATFORM CONFIG FOR WINDOWS ARM64
CXXFLAGS = /I. /O2 /std:c++17 /arm64
# END PLATFORM CONFIG FOR WINDOWS ARM64
...
SRCS = base/uid.cpp \
  ...
  form/expression_util.cpp form/expression.cpp form/formula_gen.cpp form/formula_simplify.cpp form/formula_util.cpp form/formula.cpp form/lean.cpp form/pari.cpp form/variant.cpp \
