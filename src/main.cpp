...
void help()
{
  ...
  std::cout << "  evaluate <file/seq-id> Evaluate a program to a sequence (cf. -t,-b,-s)" << std::endl;
  std::cout << "  minimize <file>        Minimize a program and print it (cf. -t)" << std::endl;
  ...
  std::cout << "  mine                   Mine programs for OEIS sequences (cf. -i)" << std::endl;
  std::cout << "  match <file>           Match a program to OEIS sequences (cf. -i)" << std::endl;
  std::cout << "  check <seq-id>         Check a program for an OEIS sequence (cf. -b)" << std::endl;
  ...
  std::cout << "  -m <number>            Maximum number of used memory cells (no limit: -1)" << std::endl;
