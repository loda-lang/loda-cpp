...
SRCS = base/uid.cpp \
  ...
  oeis/invalid_matches.cpp oeis/oeis_list.cpp oeis/oeis_manager.cpp oeis/oeis_program.cpp \
  seq/managed_sequence.cpp seq/sequence_index.cpp seq/sequence_loader.cpp seq/sequence_util.cpp \
