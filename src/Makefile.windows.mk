...
SRCS = cmd/benchmark.cpp cmd/boinc.cpp cmd/commands.cpp cmd/main.cpp cmd/test.cpp \
  eval/evaluator.cpp eval/evaluator_inc.cpp eval/interpreter.cpp eval/memory.cpp eval/minimizer.cpp eval/semantics.cpp \
  ...
  lang/analyzer.cpp lang/comments.cpp lang/constants.cpp lang/optimizer.cpp lang/parser.cpp lang/program.cpp lang/program_util.cpp lang/subprogram.cpp \
