...
const Operation::Metadata& Operation::Metadata::get( Type t )
{
  ...
  static Operation::Metadata mov { Operation::Type::MOV, "mov", 'm', 2, true, false, true, 24 };
  static Operation::Metadata add { Operation::Type::ADD, "add", 'a', 2, true, true, true, 24 };
  static Operation::Metadata sub { Operation::Type::SUB, "sub", 's', 2, true, true, true, 24 };
  static Operation::Metadata mul { Operation::Type::MUL, "mul", 'u', 2, true, true, true, 24 };
